...
interface ITimeClassroomInfoResponse {
    [0]: IResponseHead;
    [1]: {
        row: Array<ITimeClassroomInfoRow>;
    };
}
...
interface ISpecialTimeTableResponse {
    [0]: IResponseHead;
    [1]: {
        row: Array<ISpecialTimetableRow>;
    };
}
